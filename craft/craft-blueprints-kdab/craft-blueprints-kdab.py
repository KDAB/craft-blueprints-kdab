...
class subinfo(info.infoclass):
    def setTargets(self):
        for ver in ["master"]:
            self.svnTargets[ver] = f"[git]https://github.com/KDAB/craft-blueprints-kdab.git|{ver}|"
...
class Package(SourceOnlyPackageBase):
    ...
    def checkoutDir(self, index=0):
        return os.path.join(CraftStandardDirs.blueprintRoot(), "craft-blueprints-kdab")
